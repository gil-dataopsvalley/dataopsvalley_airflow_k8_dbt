...
dbt_project_Name = dataConfig['Dbt_project_Name']
# DGT_AIRFLOW_DBT_TAG = '1.0.0'

with DAG(
        # models.Variable.get(DGT_AIRFLOW_DBT_TAG),
        '19_1_dag_dataops_table_status_dbt',
    ...
    dbt_run = KubernetesPodOperator(
        ...
        # image="eu.gcr.io/dgt-gcp-egov-test-govilbi-0/dgt_govil_dbt:" + Tag_Version,
        # image="eu.gcr.io/dgt-gcp-egov-test-govilbi-0/dgt_govil_dbt:1.0.3",
        # image="me-west1-docker.pkg.dev/dgt-gcp-egov-test-govilbi-0/bi-team/dgt_govil_dbt:1.0.3",
        # image="eu.gcr.io/dgt-gcp-egov-test-govilbi-0/dgt_govil_dbt:1.0.3",
        # image="eu.gcr.io/dgt-gcp-egov-test-govilbi-0/dgt_govil_dbt:"+Tag_Version,
        # image=artifact_registry+"/"+ProjectGCP_Id+"/"+dbt_project_Name+":"+Tag_Version,
        image=artifact_registry+"/"+ProjectGCP_Id+"/"+registry_ProjectName+"/"+dbt_project_Name+":"+Tag_Version,
        # me-west1-docker.pkg.dev
        # me-west1-docker.pkg.dev/bi-team/dgt-gcp-egov-prod-govilbi-0/dgt_govil_dbt/sha256:a1aae5a4d2fb0bed09cf76bd4cb430e194ab607e70fc4d5c05c868fed974885c
        # image="eu.gcr.io/dgt-gcp-egov-test-govilbi-0/dgt_govil_dbt@sha256:1ab9f936fcf3c90c7304449278ecb1a8146095c6cce54015bb462d89bc579b96",
        # startup_timeout_seconds=500,
        cmds=["bash", "-cx"],
        # arguments=["cd" , "./dbt/dgt_govil_dbt" , "&& dbt run"], #Liad & Oded
        arguments=["cd /home/dbtuser/dgt_govil_dbt && dbt run --select z_DataOps_Status_Table"],
        labels={"foo": "bar"},
        name="dgt_govil_dbt",
