...
| Model Name | Sub-Model Name | Tags (Master,sub) | Job Frequency | Description               |
|------------|----------------|-------------------|---------------|---------------------------|
| Yuval      | Contacts       | yuval,contacts    | Daily         | יובל - אנשי קשר           |
| MyGov      | Management     | mygov,mng         | Daily         | איזור אישי - ניהול        |
| MyGov      | MoT            | mygov,mot         | Daily         | איזור אישי - משרד התחבורה | 
