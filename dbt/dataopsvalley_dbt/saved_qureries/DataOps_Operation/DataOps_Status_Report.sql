...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_DIM_Dynatrace`
...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_FACT_Billboard_Daily`
...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_DIM_YuvalContact`
...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_DIM_YuvalCustomer`
...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_FACT_ITServer`
...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_FACT_Kiosk_Log_Daily_H`
...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_FACT_Sso_By_Metric`
...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_DIM_Date`
...
FROM `dgt-gcp-egov-test-govilbi-0.GovilBiDwhDS.DWH_DIM_DigitalLiteracy_Kayma`
